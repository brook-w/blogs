...
solana catchup $(solana-keygen pubkey /root/sol/bin/validator-keypair.json) http://127.0.0.1:8899

>>> Bh1LqqiPqTbjVUD8LDucYhT2QjcvrsMXvs92fFFmvpJE has caught up (us:359300278 them:359300277)
```


### [yellowstone-grpc](https://github.com/rpcpool/yellowstone-grpc)

访问 example/golang 连接节点 Geyser gRPC 端口

```sh
go run ./cmd/grpc-client/ -endpoint http://localhost:10900 -slots
```