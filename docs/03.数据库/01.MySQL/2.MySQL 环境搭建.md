...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.79b2j7tnzbc0.jpg)

3. 点击 MySQL Community Server

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3tvs7pprxgc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5ttadztzeww0.jpg)

::: theorem 小技巧
当然也可以选择二进制包 这样是通过命令行启动 mysql 服务
:::

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1nisfup6vhq8.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5jtso9dntjc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4zato3chhao0.jpg)

3. 打开“Select Products” （选择产品）窗口，可以定制需要安装的产品清单。例如，选择“MySQL Server 8.0.26-X64”后，单击“→”添加按钮，即可选择安装MySQL服务器，如图所示。采用通用的方法，可
以添加其他你需要安装的产品

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.ikahuexgkvs.jpg)

此时如果直接“Next”（下一步），则产品的安装路径是默认的。如果想要自定义安装目录，则可以选中
对应的产品，然后在下面会出现“Advanced Options”（高级选项）的超链接

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.23lgnzzamecg.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2m17imgs0d80.jpg)

4. 在上一步选择好要安装的产品之后，单击“Next”（下一步）进入确认窗口，如图所示。单击
“Execute”（执行）按钮开始安装

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.yhxxwxgvp8w.jpg)


5. 安装完成后在“Status”（状态）列表下将显示“Complete”（安装完成），如图所示

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.18wz1xdadxs.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1jg9x52hef9c.jpg)

2. 单击“Next”（下一步）按钮，进入MySQL服务器类型配置窗口，如图所示。端口号一般选择默认
端口号3306。

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4twuloa8lp20.jpg)

其中，“Config Type”选项用于设置服务器的类型。单击该选项右侧的下三角按钮，即可查看3个选项，如
图所示。

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1mh9wov2ibwg.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.jwfutehmdt8.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1y8yrpysw674.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1aupdcgm9c74.jpg)


6. 单击“Next”（下一步）按钮，打开确认设置服务器窗口，单击“Execute”（执行）按钮

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.k8nedjdu49o.jpg)

7. 完成配置，如图所示。单击“Finish”（完成）按钮，即可完成服务器的配置。

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5sryy1vav540.jpg)


8. 如果还有其他产品需要配置，可以选择其他产品，然后继续配置。如果没有，直接选择“Next”
（下一步），直接完成整个安装和配置过程

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5nnuckgql6c0.jpg)


9. 结束安装和配置

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5lxf08o8jz80.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3ripl8iew160.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1evxt4x0reow.jpg)

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3tzfd9dbm2m0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6g0f7h479v40.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4kotuy4xpyc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.565o8qcq1qk0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.49owlr5d9w40.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4gb6sdof5ri0.jpg)

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3ik1lecexwc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5zkjzoc9k6s0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3pw4ho942ee0.jpg)

查看所有字符集：SHOW VARIABLES LIKE 'character_set_%';

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3ma8cy5nfa8.jpg)

解决方案，设置当前连接的客户端字符集 “SET NAMES GBK;”

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6pknhrenbt80.jpg)
