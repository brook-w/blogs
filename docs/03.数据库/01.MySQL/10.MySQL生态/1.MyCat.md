...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.zpnsh1krsf4.jpg)

### 2. MyCat 能干什么

#### 1. 读写分离

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1ql9ljtcmlmo.jpg)

#### 2. 数据分片

垂直拆分（分库）、水平拆分（分表）、垂直+水平拆分（分库分表）

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.5xu86yr1yj40.jpg)

#### 3. 多数据源整合

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6a4fgjxk4pg0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.7f7un11o4s00.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2hy3q9hl3620.jpg)


![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6ferdfcamnw0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6ads7fwo8gc0.jpg)

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6ezp171m5k80.jpg)

#### 2. 解压后即可使用

上传到 Linux 服务器

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.338xvvkn6yc0.jpg)

#### 3. 修改文件夹及以下文件的权限

**修改成最高权限，否则运行启动命令时，会因权限不足而报错**

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.44k6qmeb72u0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.669ec5hdxr80.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2n9bjmbts4c0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2r5j7c0olt60.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2fnzg2dsu13w.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4z6vvq5q9u40.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2104acdm1nnk.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.29ngn3udv4ro.jpg)
...
- #修改mydb1.schema.json
  ...
  ![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6wjmy00n63k0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.zxu01s6zd28.jpg)
...
```
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.36tc6gvk4ci0.jpg)

2. 在Mycat里查询mytbl表,可以看到查询语句在主从两个主机间切换

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3h83bni023c0.jpg)

### 2. 搭建双主双从

一个主机 m1 用于处理所有写请求，它的从机 s1 和另一台主机 m2 还有它的从机 s2 负责所有读请求。当 m1 主机宕机后，m2 主机负责写请求，m1、m2 互为备机

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.69bvhubs4qg0.jpg)
...
**查询Master1的状态**
`show master status;`
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.29xzxb242xog.jpg)

**查询Master2的状态**
`show master status;`
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6yesfkrkkf80.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4p8h5p0bd920.jpg)

**Slava2的复制命令**

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2xs0h6f025i0.jpg)
...
Slava1的复制Master1
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.qnjqb3ejwnk.jpg)

Slava2的复制Master2
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.pjyrcl7vrxs.jpg)
...
Master2的复制命令
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.vfkbuasoknk.jpg)

Master1的复制命令
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3mpt385iff00.jpg)
...
Master2的复制Master1
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.gpxd5fpdxlc.jpg)


Master1的复制Master2
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2apnzj8kel34.jpg)

##### 8. Master1 主机新建库、新建表、insert 记录，Master2 和从机复制

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4aouf69ykiq0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.13u1nrhdrlog.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.71gh8e5crfc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.16s3b17augqo.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.3yxcnd2u1ui0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2xhkql66zx60.jpg)

查看数据库可见，分片数据

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4l2bhfr993w0.jpg)

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.7bz65y8h5v40.jpg)

在 Mycat 终端查询依然可以看到全部数据

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.61882y7kszc0.jpg)
#### 5. 创建 ER 表
...
* 对比数据节点 1
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4ut1pxus7gy0.jpg)

* 对比数据节点 2
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2bwskfhqjg2s.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.38eqqpxp3660.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.76vc7an2fo80.jpg)

**原理如下**

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4ylm83w3hso0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6equ0csepws0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.4fausjdt52u0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2ibzj6kztjc0.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.l4uin3we3i8.jpg)

- 2. 编辑分片表

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.1cr7trfgxuq.jpg)
...
![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.2wfv47glw8m0.jpg)

- 4. 编辑全局表

![image](https://cdn.staticaly.com/gh/brook-w/image-hosting@master/mysql/image.6miv5cf6e540.jpg)
